...
export const metadata = {
  ...
  description:
    'Understand the difference between call recording software, AI conversation intelligence, and a true system of record for business conversations.',
  keywords:
    'call recording comparison, gong alternative, chorus alternative, system of record, evidence-grade recording',
}
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Understand the critical difference between passive storage, insights platforms, and
            evidence-grade systems of record.
          </p>
        </div>
      </section>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  <th className="text-left p-4 border-b-2 border-gray-200 text-gray-900 font-semibold">
                    Feature
                  </th>
                  <th className="text-center p-4 border-b-2 border-gray-200 text-gray-600 font-medium">
                    Call Recording
                  </th>
                  <th className="text-center p-4 border-b-2 border-gray-200 text-gray-600 font-medium">
                    AI Insights
                  </th>
                  <th className="text-center p-4 border-b-2 border-primary-600 bg-primary-50 text-primary-900 font-semibold">
                    Word Is Bond
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-4 border-b border-gray-200 text-center">−</td>
                  <td className="p-4 border-b border-gray-200 text-center">−</td>
                  <td className="p-4 border-b border-gray-200 text-center bg-primary-50 font-bold">
                    ✓
                  </td>
                </tr>
                <tr>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Need Evidence You Can Defend?</h2>
