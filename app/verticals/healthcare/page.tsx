...
export const metadata = {
  ...
  description: 'HIPAA-ready call recording, transcription, and audit trails for healthcare providers. Consent capture, patient intake verification, and evidentiary-grade documentation.',
  keywords: 'HIPAA compliance, healthcare call recording, medical transcription, patient consent, audit trail, healthcare documentation',
}
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Healthcare Call Recording<br />
            <span className="text-primary-600">Built for Compliance</span>
          </h1>
          
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Capture patient consent, verify intake information, and maintain evidentiary-grade 
            audit trails. Word Is Bond provides the documentation you need when it matters most.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Every feature designed to support your compliance requirements and documentation needs.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Automated verbal consent detection and timestamped acknowledgment. 
                Know exactly when consent was given and by whom.
              </p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                AI-powered transcription captures patient information accurately. 
                Review and verify intake data with full source attribution.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center gap-2">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600 mb-4">
                Complete chain of custody for every call. Know who accessed what, 
                when, and why. Export-ready for audits and legal proceedings.
              </p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Word Is Bond is designed from the ground up for regulated industries. 
                Our System of Record architecture ensures your call evidence is 
                defensible in audits, disputes, and legal proceedings.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-gray-900">HIPAA-Ready Infrastructure</h3>
                    <p className="text-sm text-gray-600">BAA available. Encrypted at rest and in transit. Access controls and audit logging.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Recordings cannot be modified. Transcripts are versioned. Every change is logged.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Self-contained evidence packages with full provenance chain. Hash-verified integrity.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <ul className="space-y-4">
                {[
                  { name: 'Source Recording', desc: 'Unmodified audio file with hash verification' },
                  { name: 'Canonical Transcript', desc: 'Versioned text with producer attribution' },
      ...
      <section id="use-cases" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From small practices to large health systems, Word Is Bond supports your documentation needs.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Capture appointment confirmations, insurance verification, and pre-visit instructions with full documentation.',
                icon: '📅',
              },
              {
                title: 'Telehealth Documentation',
                description: 'Record virtual consultations with consent capture and transcript generation for medical records.',
                icon: '💻',
              },
              {
                title: 'Prior Authorization Calls',
                description: 'Document insurance discussions with timestamped records of approvals, denials, and follow-up requirements.',
                icon: '📋',
              },
              {
                title: 'Care Coordination',
                description: 'Track referral discussions, specialist consultations, and care team communications.',
                icon: '🤝',
              },
            ].map((useCase, i) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex items-center gap-8">
              ...
              <Link href="mailto:support@voxsouth.online" className="text-sm text-gray-400 hover:text-white">Contact</Link>
            </nav>
          </div>
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} Word Is Bond. Built for compliance. Designed for trust.
            </p>
          </div>
        </div>
      </footer>
