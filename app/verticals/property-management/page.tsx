...
export const metadata = {
  ...
  description:
    'Evidence-grade call recording for property managers. Document tenant communications, maintenance requests, and dispute resolution with defensible audit trails.',
  keywords:
    'property management call recording, tenant documentation, maintenance request tracking, dispute evidence, property manager software',
}
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Built for Property Managers</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Document every maintenance call with timestamp-accurate transcripts. Track
                request-to-completion timelines and vendor coordination.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Export complete evidence bundles for eviction proceedings, security deposit
                disputes, and lease violation claims.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Serve diverse tenant populations with transcription and translation in 12+
                languages. Meet language access requirements.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Role-based access control for regional managers, property managers, and maintenance
                coordinators. Audit trails included.
              </p>
            </div>
      ...
      <section id="benefits" className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Stop Losing Disputes</h2>
              <p className="text-lg text-gray-600 mb-8">
                Property managers waste thousands annually in frivolous disputes. Word Is Bond
                provides the evidence you need to resolve conflicts quickly and fairly.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Settle disputes faster with clear documentation. Avoid costly court
                      proceedings with evidence that speaks for itself.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Document move-in/move-out conditions, maintenance agreements, and damage
                      disputes with timestamp-accurate records.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Dispute Resolution ROI</h3>
              <div className="space-y-6">
                <div>
              ...
              <p className="text-sm text-gray-500 mt-6">
                *Based on customer surveys across 50+ property management companies managing 10,000+
                units
              </p>
            </div>
          </div>
      ...
      <section id="use-cases" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Property Management Use Cases</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From single-family rentals to large apartment complexes, Word Is Bond protects your
              business.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Record application conversations, income verification calls, and lease signing discussions with timestamp accuracy.',
                icon: '👤',
              },
              {
                title: 'Maintenance Request Management',
                description:
                  'Track every maintenance call from initial report through completion. Document vendor coordination and tenant satisfaction.',
                icon: '🔧',
              },
              {
                title: 'Lease Violation Documentation',
                description:
                  'Record noise complaints, unauthorized occupants, and lease violation discussions for eviction proceedings.',
                icon: '⚠️',
              },
              {
                title: 'Move-In/Move-Out Inspections',
                description:
                  'Document property condition discussions, security deposit negotiations, and damage assessments over the phone.',
                icon: '📋',
              },
              {
                title: 'Rent Collection & Late Fees',
                description:
                  'Record rent reminder calls, payment arrangement discussions, and late fee explanations to prevent disputes.',
                icon: '💰',
              },
              {
                title: 'Emergency Response Coordination',
                description:
                  'Track after-hours emergency calls, vendor dispatch times, and tenant communication during urgent repairs.',
                icon: '🚨',
              },
            ].map((useCase, i) => (
      ...
      <section className="py-20 px-6 bg-primary-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Protect Your Properties Today</h2>
          <p className="text-xl text-primary-100 mb-8">
            Join property managers who trust Word Is Bond for tenant documentation and dispute
            resolution.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
