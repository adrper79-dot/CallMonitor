    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-semibold text-gray-900 mb-4">Trust Pack</h1>
          <p className="text-xl text-gray-600">
            How we handle your data, what we guarantee,
            <br />
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none">
            <p>
              A <strong>system of record</strong> is the authoritative source for a particular piece
              of data. When disputes arise, when questions are asked, when proof is needed — the
              system of record is where you go.
            </p>
            <p>
            ...
            <ul>
              <li>
                <strong>Source recordings are never modified</strong> after capture
              </li>
              <li>
                <strong>Transcripts are versioned and immutable</strong> — changes create new
                versions
              </li>
              <li>
                <strong>Every artifact has provenance</strong> — who created it, when, and how
              </li>
              <li>
                <strong>Cryptographic hashes</strong> ensure integrity can be verified
              </li>
              <li>
                <strong>Audit logs track all access</strong> — who viewed what, when
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            ...
            defensible, canonical) or <strong>Preview</strong> (real-time assist only, not
            evidential).
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-gray-500">Telnyx</td>
                ...
                <tr>
                  ...
                  <td className="py-3 px-4">
                    <AuthBadge type="preview" />
                  </td>
                  <td className="py-3 px-4 text-gray-500">Telnyx AI</td>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Data Retention Policy</h2>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Export Guarantees</h2>
          <div className="prose prose-gray max-w-none">
            <p>
              Your data is yours. We provide complete, self-contained export bundles that work{' '}
              <strong>without Wordis Bond</strong>.
            </p>
            <p>Every export includes:</p>
            <ul>
              <li>
                <strong>Call metadata</strong> — timestamps, participants, duration
              </li>
              <li>
                <strong>Source recording</strong> — original audio file
              </li>
              <li>
                <strong>Canonical transcript</strong> — versioned, with hashes
              </li>
              <li>
                <strong>Translations</strong> — if applicable
              </li>
              <li>
                <strong>Scores & surveys</strong> — all QA data
              </li>
              <li>
                <strong>Evidence manifest</strong> — cryptographic provenance chain
              </li>
              <li>
                <strong>README</strong> — human-readable explanation of contents
              </li>
            </ul>
            <p>
              Export bundles are <strong>deterministic</strong> — the same call will always produce
              the same export. Hash verification is built in.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Evidence Independence</h2>
