...
export default function VoiceOperationsClient({
  ...
  // Polling fallback for active call status
  useEffect(() => {
  ...
  // Timer for active calls - runs during initiating and in_progress states
  useEffect(() => {
    if (!activeCallId) return
    const terminalStates = ['completed', 'failed', 'no-answer', 'busy']
    if (activeCallStatus && terminalStates.includes(activeCallStatus)) return
              ...
              <div className="flex lg:hidden flex-col flex-1 overflow-hidden">
                ...
                <nav className="flex border-t border-gray-200 bg-white safe-area-bottom">
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center py-3 px-2 min-h-[56px] transition-colors ${mobileTab === 'dial'
                  ...
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center py-3 px-2 min-h-[56px] transition-colors relative ${mobileTab === 'calls'
                      ? 'text-primary-600 bg-primary-50'
                      : 'text-gray-500 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center py-3 px-2 min-h-[56px] transition-colors ${mobileTab === 'activity'
                      ? 'text-primary-600 bg-primary-50'
                      : 'text-gray-500 hover:bg-gray-50'
                      }`}
                  >
