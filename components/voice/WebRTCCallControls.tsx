      ...
      <div className="space-y-4">
              ...
              <div className="mt-3 pt-3 border-t border-success/10 grid grid-cols-2 gap-2 text-xs">
                {quality.audio_bitrate && (
                  <div>
                    ...
                    <span className="font-mono">{Math.round(quality.audio_bitrate / 1000)}kbps</span>
                  </div>
                )}
        ...
        {callState === 'active' && (
          <div className="grid grid-cols-3 gap-2">
            ...
            >
              {isMuted ? (
                <svg className="w-6 h-6 mb-1 text-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            >
              <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 3.75L18 6m0 0l2.25 2.25M18 6l2.25-2.25M18 6l-2.25 2.25m-12 8.25c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
              </svg>
