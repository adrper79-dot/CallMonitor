    ...
    >
      ...
      {showEmailForm && (
        <div className="p-4 bg-gray-50 border-b border-gray-200">
          ...
          {emailStatus && (
            <p
              className={`text-sm mt-2 ${emailStatus.type === 'success' ? 'text-green-600' : 'text-red-600'}`}
            >
              {emailStatus.message}
            </p>
          )}
      ...
      <Tabs defaultValue={defaultTab} className="w-full">
        <TabsList className="w-full border-b border-gray-200">
          ...
          {hasTranslation && <TabsTrigger value="translation">Translation</TabsTrigger>}
          {hasSurvey && <TabsTrigger value="survey">Survey</TabsTrigger>}
          {hasManifest && <TabsTrigger value="manifest">Manifest</TabsTrigger>}
          {hasScore && <TabsTrigger value="score">Score</TabsTrigger>}
        </TabsList>

        {hasRecording && (
          <TabsContent value="recording" className="p-4" data-tour="recording-player">
            <RecordingPlayer
        ...
        {hasTranscript && (
          <TabsContent value="transcript" className="p-4" data-tour="transcript-view">
