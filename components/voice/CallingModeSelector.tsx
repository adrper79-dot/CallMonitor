...
/**
 * Calling Mode Type
 * - phone: Traditional REST API calling (Telnyx calls your phone)
    ...
    <div className="bg-white rounded-md border border-gray-200 p-3">
      <div className="flex items-center justify-between mb-2">
        ...
        {mode === 'browser' && webrtcStatus && (
          <Badge
            variant={
              webrtcStatus === 'connected' || webrtcStatus === 'on_call'
                ? 'success'
                : webrtcStatus === 'connecting' || webrtcStatus === 'initializing'
                  ? 'warning'
                  : webrtcStatus === 'error'
                    ? 'error'
                    : 'default'
