...
export default function BondAIChat({ contextType, contextId, className }: BondAIChatProps) {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 w-[420px] h-[600px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col overflow-hidden ${className || ''}`}>
      {/* Header */}
            ...
            conversations.map(conv => (
              ...
              >
                ...
                <div className="flex items-center gap-2 text-xs text-gray-400 mt-0.5">
                  {conv.context_type && (
                    <span className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">{conv.context_type}</span>
                  )}
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 && (
              <div className="text-center py-8">
                ...
                <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Hi! I&apos;m Bond AI</h4>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-[280px] mx-auto">
                  I can help you understand your call data, review test results, analyze scorecards, and more.
                </p>
