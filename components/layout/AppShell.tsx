...
export function AppShell({ children, organizationName, organizationId, userEmail }: AppShellProps) {
  ...
  const getNavSections = (): NavSection[] => {
    ...
    if (isAgent) {
          ...
          items: [
            {
              href: '/inbox',
              label: 'Inbox',
              badge: unreadCount?.total || undefined,
              icon: (
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: (
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h-.008v.008h.008V8.25zm0 2.25h.008v.008H7.5V10.5zm0 2.25h.008v.008H7.5V12.75zm0 2.25h.008v.008H7.5v-.008zm0 2.25h.008v.008H7.5V17.25zm7.5-9h.008v.008H15V8.25zm0 2.25h.008v.008H15V10.5zm0 2.25h.008v.008H15V12.75zm0 2.25h.008v.008H15v-.008zm0 2.25h.008v.008H15V17.25z" />
                </svg>
              ),
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              icon: (
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.25a9.75 9.75 0 100 19.5 9.75 9.75 0 000-19.5zM12 12a3 3 0 100-6 3 3 0 000 6z" />
                </svg>
              ),
            },
            {
      ...
      // Admin gets Manager nav + Admin section
      return [
        {
          title: '',
          items: [
      ...
      // Default/fallback nav for viewers or unknown roles
      return [
        {
          title: '',
          items: [
