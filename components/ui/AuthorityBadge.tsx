...
export function AuthorityBadge({ 
  ...
  if (!isAuthoritative) {
    return (
      <Badge 
        variant="warning"
        className={className}
        title={showTooltip ? "This artifact is for real-time assist only and not recorded as evidence." : undefined}
      >
        <svg 
  ...
  return (
    <Badge 
      variant="success"
      className={className}
      title={showTooltip ? "This artifact is the canonical source of truth and legally defensible." : undefined}
    >
      <svg 
        className="w-3 h-3 mr-1" 
        fill="none" 
