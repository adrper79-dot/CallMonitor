...
export const metadata = {
  ...
  description: 'Attorney-client privilege protection with evidentiary-grade call recording for law firms. Secure intake documentation, consultation records, and malpractice defense.',
  keywords: 'legal call recording, attorney client privilege, law firm documentation, legal intake, malpractice protection, evidence grade recording',
}
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="#compliance" className="text-sm text-gray-600 hover:text-gray-900">Security</Link>
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 rounded-full mb-8">
            ...
            <span className="text-sm font-medium text-purple-700">Attorney-Client Privilege Protected</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Every feature designed to support attorney-client privilege and professional responsibility.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Capture initial consultations with timestamp-accurate transcripts. Document conflict checks, 
                retainer agreements, and scope discussions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Role-based access control ensures attorney-client communications remain confidential. 
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Immutable audit trails with SHA-256 hashing. Export complete evidence bundles 
                for court proceedings or disciplinary defense.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Transcribe and translate client communications in 12+ languages. 
                Serve immigrant communities while maintaining accurate records.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Document client instructions, advice given, and scope limitations. 
                Defendable evidence for professional liability claims.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Configurable retention from 1 to 7+ years to meet state bar requirements. 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Word Is Bond is designed from the ground up for regulated professions. 
                Our System of Record architecture ensures your client evidence is 
                defensible in malpractice claims, fee disputes, and bar proceedings.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Meet recordkeeping requirements across all 50 states with configurable retention 
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      One-click export of complete evidence bundles with chain of custody documentation 
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <svg className="w-4 h-4 text-purple-500 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Legal hold support
                </li>
      ...
      <section id="use-cases" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From solo practitioners to AmLaw 200 firms, Word Is Bond supports your documentation needs.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Record initial consultations with conflict check documentation, retainer discussions, and scope of representation clarity.',
                icon: '⚖️',
              },
              {
                title: 'Immigration Law Documentation',
                description: 'Capture client interviews in their native language with accurate transcription and translation for case files.',
                icon: '🌐',
              },
              {
                title: 'Family Law Mediation',
                description: 'Document settlement negotiations, child custody discussions, and support agreements with timestamp accuracy.',
                icon: '👨‍👩‍👧‍👦',
              },
              {
                title: 'Personal Injury Case Building',
                description: 'Record client injury descriptions, medical history intake, and ongoing status updates for case documentation.',
                icon: '🏥',
              },
              {
                title: 'Estate Planning Discussions',
                description: 'Capture testamentary intent, beneficiary instructions, and asset distribution wishes with evidentiary-grade records.',
                icon: '📜',
              },
              {
                title: 'Client Instruction Verification',
                description: 'Document settlement authority, litigation decisions, and strategy approvals to defend against malpractice claims.',
                icon: '✅',
              },
            ].map((useCase, i) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex items-center gap-8">
              ...
              <Link href="/docs/API" className="text-sm text-gray-400 hover:text-white">API Docs</Link>
