-- ============================================================================
-- TIER 1 FEATURES MIGRATION (FIXED)
...
-- PREREQUISITE CHECK: Ensure calls table has organization_id
-- This should already exist, but we'll add it safely if missing
DO $$ 
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Added missing organization_id column to calls table';
  END IF;
END $$;
