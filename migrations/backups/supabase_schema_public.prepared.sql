...
ALTER TYPE text OWNER TO neondb_owner;
...
-- Name: user_has_tool_access(uuid, uuid, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text DEFAULT 'viewer'::text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text) OWNER TO neondb_owner;

--

-- Name: FUNCTION user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text) IS 'Check if a user has access to a tool at a given role level';
...
ALTER VIEW public.call_debug_view OWNER TO neondb_owner;
...
CREATE POLICY "Tool admins can manage team members" ON public.tool_team_members FOR INSERT WITH CHECK ((organization_id IN ( SELECT tool_team_members_1.organization_id
  ...
  WHERE ((tool_team_members_1.user_id = auth.uid()) AND (tool_team_members_1.role = 'admin'::text)))));
...
CREATE POLICY "Tool admins can update settings" ON public.tool_settings FOR UPDATE USING ((organization_id IN ( SELECT tool_team_members.organization_id
  ...
  WHERE ((tool_team_members.user_id = auth.uid()) AND (tool_team_members.role = 'admin'::text)))));
...
CREATE POLICY cas_delete_calls ON public.calls FOR DELETE USING ((EXISTS ( SELECT 1
  ...
  WHERE ((ta.organization_id = calls.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = 'admin'::text)))));
...
CREATE POLICY cas_delete_recordings ON public.recordings FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_recorder'::text) AND (ta.role = 'admin'::text)))));
...
CREATE POLICY cas_delete_scorecards ON public.scorecards FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scorecards.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = 'admin'::text)))));
...
CREATE POLICY cas_delete_scored_recordings ON public.scored_recordings FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scored_recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = 'admin'::text)))));
...
CREATE POLICY cas_delete_test_configs ON public.test_configs FOR DELETE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = test_configs.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = 'admin'::text)))));
...
CREATE POLICY cas_insert_calls ON public.calls FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = calls.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_insert_recordings ON public.recordings FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_recorder'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_insert_scorecards ON public.scorecards FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scorecards.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_insert_scored_recordings ON public.scored_recordings FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scored_recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_insert_test_configs ON public.test_configs FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = test_configs.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_select_calls ON public.calls FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = calls.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text)))));
...
CREATE POLICY cas_select_recordings ON public.recordings FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_recorder'::text)))));
...
CREATE POLICY cas_select_scorecards ON public.scorecards FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scorecards.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text)))));
...
CREATE POLICY cas_select_scored_recordings ON public.scored_recordings FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scored_recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text)))));
...
CREATE POLICY cas_select_test_configs ON public.test_configs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = test_configs.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text)))));
...
CREATE POLICY cas_update_calls ON public.calls FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = calls.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = calls.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_update_recordings ON public.recordings FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_recorder'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_recorder'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_update_scorecards ON public.scorecards FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scorecards.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scorecards.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_update_scored_recordings ON public.scored_recordings FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scored_recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = scored_recordings.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_analysis'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
CREATE POLICY cas_update_test_configs ON public.test_configs FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = test_configs.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.tool_access ta
  WHERE ((ta.organization_id = test_configs.organization_id) AND (ta.user_id = auth.uid()) AND (ta.tool = 'call_monitor'::text) AND (ta.role = ANY (ARRAY['admin'::text, 'editor'::text]))))));
...
-- Name: FUNCTION user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text) TO anon;
GRANT ALL ON FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text) TO authenticated;
GRANT ALL ON FUNCTION public.user_has_tool_access(p_user_id uuid, p_org_id uuid, p_tool text, p_min_role text) TO service_role;
