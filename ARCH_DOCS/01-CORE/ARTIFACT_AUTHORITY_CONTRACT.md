...
|-----------|-------------|-------|
| Telnyx recording | Authoritative input | Source audio, immutable |
...
| **Recordings** | `recordings` | Yes | No | Telnyx | Insert-only policy | Source media (never modified) |
...
|----------|----------|----------------------|------------------------|
| **Live Translation** | Telnyx AI / AssemblyAI | Real-time assist, latency-optimized (not accuracy-optimized) | Not persisted |
...
|----------|-------------------|-------------|-------|
| **Telnyx** | `recordings` | High | Carrier-grade media capture |
...
| **Telnyx/AssemblyAI Agent** | Live translation | Low (Preview) | Real-time assist only |
...
| vendor | telnyx-webhook | External vendor webhook |
...
- **Canonical provider** (AssemblyAI, Telnyx): Authoritative
...
await supabase.from('recordings').insert({
  ...
  produced_by: 'telnyx',         // Producer attribution
